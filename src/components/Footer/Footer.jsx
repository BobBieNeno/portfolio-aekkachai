    ...
    <footer className="footer">
      <div className="container footer__inner">
        ...
        <div className="footer__left">
          <a className="footer__logo" onClick={scrollTop} style={{ cursor: 'pointer' }}>
            <span className="footer-ui">UI</span>
            <span className="footer-senjor">SENJOR<span className="footer-dot">.</span></span>
          </a>
          <p className="footer__copy">
            © {year} UI SENJOR. Built with React &amp; passion for good software.
          </p>
        </div>
